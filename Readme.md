...
# Parsing + Configuration Script – AgroSense GPS Tracker NEO_6M - Rev. A

This **Parsing + Configuration** script is designed for the **AgroSense GPS Tracker NEO_6M** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AgroSense GPS Tracker NEO_6M Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AgroSense GPS Tracker NEO_6M** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
